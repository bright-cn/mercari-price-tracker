...
[![Mercari Price Tracker](https://img.shields.io/badge/Mercari%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://bright.cn/products/insights/price-tracker/mercari)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://bright.cn/products/insights/price-tracker/mercari)

实时 Mercari 价格追踪——面向日本和美国领先的 C2C 市场。两种入门方式：**全托管**情报平台，或用于构建自有数据管道的**自助式 API**。

---

## 选项 1：Bright Insights - AI 驱动的价格追踪（推荐）

**[Bright Insights](https://bright.cn/products/insights/price-tracker/mercari)** 是 Bright Data 的全托管零售情报平台。无需构建 scraper，无需维护基础设施——只需将结构化、可直接分析的价格数据交付到仪表板、数据源或您的 BI 工具中。
...
> **每月 $250 起 —— [获取定制报价 →](https://bright.cn/products/insights/price-tracker/mercari)**

---

## 选项 2：通过 Web Scraper API 自助使用

更倾向于构建自己的数据管道？Bright Data 的 **Web Scraper API** 为您提供对 Mercari 商品数据的编程访问——包括价格、库存状态、评论等——无需管理代理或抓取基础设施。
...
- 一个用于 Mercari 商品的 Bright Data **Web Scraper ID**（[在 Web Scrapers 控制面板中查找](https://bright.cn/cp/scrapers)）
...
1. **克隆此 repository**
   ...
   ```bash
   git clone https://github.com/bright-cn/mercari-price-tracker.git
...
3. **配置凭证**
   ...
   > 搜索 “Mercari”，然后复制 Web Scraper ID（格式：`gd_xxxxxxxxxxxx`）。
...
传入一组 Mercari 商品 URL 以获取结构化价格数据：
...
- 🌟 [Mercari Price Tracker - Bright Insights (Managed)](https://bright.cn/products/insights/price-tracker/mercari)
- 🔧 [Mercari Scraper API](https://bright.cn/products/web-scraper/mercari)
